...
Belangrijk, Gherkin is geen test tool/framework. Het is geen vervanging voor andere testen zoals unit testen, integratie testen, performance testen, etc. Het is eerder een vervanging voor traditionele specificatie documenten. Het primaire doel van een Gherkin feature bestand is begrijpbare, levende documentatie. Het levend houden van de documentatie wordt bereikt door de specificaties om te zetten naar uitvoerbare specificaties die valideren dat documentatie en implementatie niet uit elkaar lopen.
