...
Functionaliteit: Persoon stap definities
  ...
  Scenario: minderjarige is geadopteerd door één meerderjarige
    ...
    * is minderjarig
    ...
    | 2     | 1            | 0         | 0       | 000000012         | gisteren - 45 jaar | 1AQ0100 | vandaag                    |
  ...
  Scenario: minderjarige met één ouder is geadopteerd door één meerderjarige
    ...
    * is minderjarig
    ...
    | pl_id | persoon_type | stapel_nr | volg_nr | burger_service_nr | geboorte_datum     |
    | 2     | P            | 0         | 0       | 000000024         | gisteren - 45 jaar |
    | 2     | K            | 0         | 0       | 000000036         | gisteren - 17 jaar |
    En heeft de persoon 'Bert' de volgende rij in tabel 'lo3_pl'
    | pl_id | geheim_ind |
    | 3     | 0          |
    En heeft de persoon 'Bert' de volgende rijen in tabel 'lo3_pl_persoon'
    | pl_id | persoon_type | stapel_nr | volg_nr | burger_service_nr | geboorte_datum     | akte_nr | familie_betrek_start_datum |
    | 3     | P            | 0         | 1       | 000000036         | gisteren - 17 jaar |         |                            |
    | 3     | P            | 0         | 0       | 000000036         | gisteren - 17 jaar | 1AQ0100 |                            |
    | 3     | 1            | 0         | 0       | 000000012         | gisteren - 45 jaar |         | gisteren                   |
    | 3     | 2            | 0         | 0       | 000000024         | gisteren - 45 jaar | 1AQ0100 | vandaag                    |
