...
Functionaliteit: Erkenning
  ...
  Scenario: {kind} is erkend door {ouder} op {datum} - de erkenner is nog niet eerder opgegeven
    Gegeven de morgen 17 jaar geleden geboren 'P1'
    En 'P1' is erkend door 'P2' op 1-2-2023
    Als de sql statements gegenereerd uit de gegeven stappen zijn uitgevoerd
    Dan heeft persoon 'P1' de volgende rij in tabel 'lo3_pl'
      | pl_id | geheim_ind |
      | P1    |          0 |
    En heeft persoon 'P1' de volgende rij in tabel 'lo3_pl_persoon'
      | pl_id | stapel_nr | volg_nr | persoon_type | geslachts_naam | geboorte_datum   | burger_service_nr | geboorte_land_code | akte_nr |
      | P1    |         0 |       1 | P            | P1             | morgen - 17 jaar |         000000012 |               6030 | 1_A____ |
    En heeft persoon 'P1' de volgende rij in tabel 'lo3_pl_persoon'
      | pl_id | stapel_nr | volg_nr | persoon_type | geslachts_naam | geboorte_datum   | burger_service_nr | geboorte_land_code | akte_nr |
      | P1    |         0 |       0 | P            | P1             | morgen - 17 jaar |         000000012 |               6030 | 1_C____ |
    En heeft persoon 'P1' de volgende rij in tabel 'lo3_pl_persoon'
      | pl_id | stapel_nr | volg_nr | persoon_type | burger_service_nr | geslachts_naam | akte_nr | familie_betrek_start_datum | geslachts_aand | geboorte_datum     |
      | P1    |         0 |       0 |            1 |         000000024 | P2             | 1_C____ |                   20230201 | M              | gisteren - 45 jaar |
    En heeft persoon 'P1' de volgende rij in tabel 'lo3_pl'
      | pl_id | geheim_ind |
      | P2    |          0 |
    En heeft persoon 'P1' de volgende rij in tabel 'lo3_pl_persoon'
      | pl_id | stapel_nr | volg_nr | persoon_type | geslachts_naam | geboorte_datum     | burger_service_nr | geslachts_aand | geboorte_land_code | akte_nr |
      | P2    |         0 |       0 | P            | P2             | gisteren - 45 jaar |         000000024 | M              |               6030 | 1_A____ |
    En heeft persoon 'P1' de volgende rij in tabel 'lo3_pl_persoon'
      | pl_id | stapel_nr | volg_nr | persoon_type | burger_service_nr | geslachts_naam | akte_nr | geboorte_datum   |
      | P2    |         0 |       0 | K            |         000000012 | P1             | 1_C____ | morgen - 17 jaar |

  Scenario: {kind} is erkend door {ouder} op {datum} - de erkenner is nog niet eerder opgegeven maar wel een andere ouder
    Gegeven de minderjarige persoon 'P1' met één ouder 'P2'
    En 'P1' is erkend door 'P3' op 1-2-2023
    Als de sql statements gegenereerd uit de gegeven stappen zijn uitgevoerd
    Dan heeft persoon 'P1' de volgende rij in tabel 'lo3_pl'
      | pl_id | geheim_ind |
      | P1    |          0 |
    En heeft persoon 'P1' de volgende rij in tabel 'lo3_pl_persoon'
      ...
      | P1    |         0 |       1 | P            |         000000103 | P1             | gisteren - 17 jaar |               6030 | 1_A____ |
    En heeft persoon 'P1' de volgende rij in tabel 'lo3_pl_persoon'
      | pl_id | stapel_nr | volg_nr | persoon_type | burger_service_nr | geslachts_naam | geboorte_datum     | geboorte_land_code | akte_nr |
      | P1    |         0 |       0 | P            |         000000103 | P1             | gisteren - 17 jaar |               6030 | 1_C____ |
    En heeft persoon 'P1' de volgende rij in tabel 'lo3_pl_persoon'
      ...
      | P1    |         0 |       0 |            1 | gisteren - 17 jaar         | 1_A____ |         000000101 | P2             | morgen - 37 jaar | V              |
    En heeft persoon 'P1' de volgende rij in tabel 'lo3_pl_persoon'
      | pl_id | stapel_nr | volg_nr | persoon_type | akte_nr | geldigheid_start_datum |
      | P1    |         0 |       1 |            2 | 1_A____ | gisteren - 17 jaar     |
    En heeft persoon 'P1' de volgende rij in tabel 'lo3_pl_persoon'
      | pl_id | stapel_nr | volg_nr | persoon_type | familie_betrek_start_datum | akte_nr | burger_service_nr | geslachts_naam | geboorte_datum     | geslachts_aand |
      | P1    |         0 |       0 |            2 |                   20230201 | 1_C____ |         000000036 | P3             | gisteren - 45 jaar | M              |
    En heeft persoon 'P2' de volgende rij in tabel 'lo3_pl'
      | pl_id | geheim_ind |
      | P2    |          0 |
    En heeft persoon 'P2' de volgende rij in tabel 'lo3_pl_persoon'
      | pl_id | stapel_nr | volg_nr | persoon_type | burger_service_nr | geslachts_naam | geboorte_datum   | geslachts_aand | akte_nr |
      | P2    |         0 |       0 | P            |         000000101 | P2             | morgen - 37 jaar | V              | 1_A____ |
    En heeft persoon 'P3' de volgende rij in tabel 'lo3_pl'
      | pl_id | geheim_ind |
      | P3    |          0 |
    En heeft persoon 'P3' de volgende rij in tabel 'lo3_pl_persoon'
      | pl_id | stapel_nr | volg_nr | persoon_type | burger_service_nr | geslachts_naam | geboorte_datum     | geslachts_aand | akte_nr | geslachts_aand |
      | P3    |         0 |       0 | P            |         000000036 | P3             | gisteren - 45 jaar | M              | 1_A____ | M              |
    En heeft persoon 'P1' de volgende rij in tabel 'lo3_pl_persoon'
      | pl_id | stapel_nr | volg_nr | persoon_type | akte_nr | burger_service_nr | geslachts_naam | geboorte_datum     |
      | P3    |         0 |       0 | K            | 1_C____ |         000000103 | P1             | gisteren - 17 jaar |
